...
def get_data(year):
	for page in range (10):
		url = 'http://www.cpbl.com.tw/stats/all.html?year='+str(year)+'&stat=ppit&online=1&sort=G&order=desc&per_page='+str(page)
		#http://www.cpbl.com.tw/stats/all.html?&game_type=01&online=0&year=2020&stat=ppit&sort=G&order=desc
...
excel.to_csv('CBPL_ppit_'+str(year)+'_data.csv' , encoding = 'UTF-8-sig')